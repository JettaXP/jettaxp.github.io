...
- `/windows` - версия сайта в стиле шиндовс 95
- `/macos` - тоже самое что ios и ipados (
- `/linux` - версия сайта в linux-tty-стиле
- `/ios` & `/ipados` - одно и тоже
- `/os` - перенаправление на сайт по ос (по стандарту)
- `/material` — версии сайтов в материал дизайне
- `/fluid` — попытка сделать флуид дизайн винды :/ 
- `/ai` — нейронка (временно сломанна)
